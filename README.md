...
Summary:
- carefully set up the phantom. Use the spirit level insert, keep bubble within the ring. Respect I/S and R/L markers in the phantom. Carefully avoid rotation around A/P axis for reliable marker detection.
- head coil
